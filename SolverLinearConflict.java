...
public class SolverLinearConflict {
    private class Move implements Comparable<Move> {
        ...
        public int compareTo(Move move) {
            return (this.board.linearconflict() - move.board.linearconflict()) + (this.numMoves - move.numMoves);
        }
    }
    ...
    int anothernode = 0;
    public SolverLinearConflict(Board initial) {
